    ...
    return Column(children: [
      ...
      _buildStatsCard(
        ...
        rows: !_statsLoading ? [
          ...
          _statRow('Propriétés commerciales cédées', _stats['hist72_propCommerciale'] ?? 0,  Colors.orange.shade200,
              typeFilter: 'Propriété commerciale',                            initialHistorique: true),
          _statRow('Propriétés industrielles cédées', _stats['hist72_propIndustrielle'] ?? 0, Colors.amber.shade200,
              typeFilter: 'Propriété industrielle',                           initialHistorique: true),
          ...
          _statRow('Concessions vendues',            _stats['hist72_concessionVendue'] ?? 0, Colors.orange.shade300,
              typeFilter: 'Concession',                                       initialHistorique: true),
          _statRow('Chambres d’hôtel occupées',      _stats['hist72_chambreHotel'] ?? 0,     Colors.amber.shade300,
              typeFilter: 'Chambre d’hôtel',                                  initialHistorique: true),
          _statRow('Salles des fêtes occupées',      _stats['hist72_salleFetes'] ?? 0,       Colors.amber.shade200,
              typeFilter: 'Salle de fêtes',                                   initialHistorique: true),
          _statRow('Salles polyvalentes occupées',   _stats['hist72_sallePolyvalente'] ?? 0, Colors.amber.shade200,
              typeFilter: 'Salle polyvalente',                                initialHistorique: true),
          _statRow('Espaces funéraires cédés',       _stats['hist72_espaceFuneraire'] ?? 0,  Colors.orange.shade200,
              typeFilter: 'Espace funéraire',                                 initialHistorique: true),
          const Divider(height: 1, color: Colors.white12),
